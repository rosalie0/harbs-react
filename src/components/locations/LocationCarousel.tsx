...
const goToSlide = (slideIndex: number) => {
  ...
  return (
    <div className='border-4 max-w-[1400px] h-[780px] w-full m-auto py-16 px-4 relative overflow-x-hidden'>
        ...
        <div className="absolute top-[40%] -translate-x-0 tranlate-y-[50%] left-5 text2xl rounded-full p-2 bg-black/50 text-white cursor-pointer"><BsChevronCompactLeft onClick={prevSlide} size={30}/></div>
        <div className="absolute top-[40%] -translate-x-0 tranlate-y-[50%] right-5 text2xl rounded-full p-2 bg-black/50 text-white cursor-pointer"><BsChevronCompactRight onClick={nextSlide} size={30}/></div>
